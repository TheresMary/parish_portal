...
var MCSaveUser = function () {
    ...
    const handleSubmit = () => {
        ...
        // Get elements
        const form = document.getElementById('create-or-update-observation-category-form');
        const submitButton = document.getElementById('create-or-update-observation-category-submit');
        ...
        submitButton.addEventListener('click', async e => {
            ...
            if (validator) {
                try {
                    ...
                    formData.append('observation_category_id', document.querySelector('[name="observation_category_id"]').value);
                    ...
                    if (status === 'Valid') {
                        const btn = document.getElementById('create-or-update-observation-category-submit');
