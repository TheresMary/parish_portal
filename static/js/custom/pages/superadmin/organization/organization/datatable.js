...
var DatatablesServerSide = function() {
    ...
    var initDatatable = function() {
        dt = $("#organization-dataTable").DataTable({
            "paging": true,
            "pagingType": "simple",
            "pageLength": 5,
            ...
            "initComplete": function() {
                ...
                // Searchbar styles
                $('#organization-dataTable_wrapper .dt-search').addClass('hidden');
            },
            searchDelay: 500,
            serverSide: true,
            responsive: true,
            ...
            drawCallback: function() {
                ...
                $('#organization-dataTable_length').addClass('flex items-center space-x-2 text-sm bg-white');
                $('#organization-dataTable_length select').addClass('px-3 py-1 bg-white border border-gray-300 text-gray-700 text-sm rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500');
                $('#organization-dataTable_wrapper .bottom').addClass('flex justify-end items-center gap-x-9 py-6');
                $('#organization-dataTable_length label').addClass('text-zinc-950 font-normal text-sm');
                $('#organization-dataTable_paginate .page-link').addClass('text-zinc-500 text-sm');
                $('#organization-dataTable_wrapper .dt-search label').addClass('hidden');
                $('#organization-dataTable td').removeClass('p-3 text-end');
                $('#organization-dataTable th').removeClass('text-end');
                $('#organization-dataTable td').addClass('p-4 border-b');
                $('#organization-dataTable_wrapper .dt-search label').addClass('hidden');
            }
        });
        ...
        $('#organization-dataTable tbody').on('change', 'input[type="checkbox"]', function() {
            if (!this.checked) {
    ...
    var updateSelectedCount = function() {
      var selectedCount = $('#organization-dataTable tbody input[type="checkbox"]:checked').length;
