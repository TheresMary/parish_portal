...
var deleteFromViewPages = function() {
    ...
    var handleDeleteEntries = () => {
        const deleteButtons = document.querySelectorAll('[data-learning-material-category-function="delete_entry"]');
        const  lmflag = api_config.has_learning_material

        let hasLearningMaterial = lmflag === "False" ? false : lmflag === "True" ? true : lmflag;
                  ...
                  Swal.fire({
                    ...
                    if (result.value) {
                      $.ajax({
                        ...
                        type: "POST",
                        data: { ids: api_config.record_id, reassign_to: checkedCategoryIds },
                        headers: {
